...
export default function EditMentoringVisitPage() {
  ...
  const initialValues = {
    ...
    full_session_observed: visit.full_session_observed === true ? 1 : visit.full_session_observed === false ? 0 : undefined,
    ...
    class_started_on_time: visit.class_started_on_time === true ? 1 : visit.class_started_on_time === false ? 0 : undefined,
    ...
    // Map DB fields to form fields (DB → Form)
    children_grouped_appropriately: visit.students_grouped_by_level === true ? 1 : visit.students_grouped_by_level === false ? 0 : undefined,
    students_fully_involved: visit.students_active_participation === true ? 1 : visit.students_active_participation === false ? 0 : undefined,
    has_session_plan: visit.teacher_has_lesson_plan === true ? 1 : visit.teacher_has_lesson_plan === false ? 0 : undefined,
    no_session_plan_reason: visit.no_lesson_plan_reason,
    followed_session_plan: visit.followed_lesson_plan === true ? 1 : visit.followed_lesson_plan === false ? 0 : undefined,
    no_follow_plan_reason: visit.not_followed_reason,
    session_plan_appropriate: visit.plan_appropriate_for_levels === true ? 1 : visit.plan_appropriate_for_levels === false ? 0 : undefined,
    session_plan_notes: visit.lesson_plan_feedback,
    ...
    activity1_clear_instructions: visit.activity1_clear_instructions === true ? 1 : visit.activity1_clear_instructions === false ? 0 : undefined,
    activity1_no_clear_instructions_reason: visit.activity1_no_clear_instructions_reason,
    activity1_followed_process: visit.activity1_followed_process === true ? 1 : visit.activity1_followed_process === false ? 0 : undefined,
    activity1_not_followed_reason: visit.activity1_not_followed_reason,
    activity1_demonstrated: visit.activity1_demonstrated === true ? 1 : visit.activity1_demonstrated === false ? 0 : undefined,
    ...
    activity2_clear_instructions: visit.activity2_clear_instructions === true ? 1 : visit.activity2_clear_instructions === false ? 0 : undefined,
    activity2_no_clear_instructions_reason: visit.activity2_no_clear_instructions_reason,
    activity2_followed_process: visit.activity2_followed_process === true ? 1 : visit.activity2_followed_process === false ? 0 : undefined,
    activity2_not_followed_reason: visit.activity2_not_followed_reason,
    activity2_demonstrated: visit.activity2_demonstrated === true ? 1 : visit.activity2_demonstrated === false ? 0 : undefined,
    ...
    activity3_clear_instructions: visit.activity3_clear_instructions === true ? 1 : visit.activity3_clear_instructions === false ? 0 : undefined,
    activity3_no_clear_instructions_reason: visit.activity3_no_clear_instructions_reason,
    activity3_demonstrated: visit.activity3_demonstrated === true ? 1 : visit.activity3_demonstrated === false ? 0 : undefined,
